    ...
    public class EncryptionDecryption
    {
        ...
        public string keys(string metinBinary)//spn16 şifreleme işlemenin yapıldığı fonksiyon
        {
            ...
            for (int i = 0; i < 4; i++)//8 karakterli şifre olacağından 4 sefer çalışan for döngüsü
            {
                ...
                /*Karma işlemi sadece 2 sefer uygulandığından algoritmadaki sıralamaya uygun olarak koşul koyuldu. Karma işlemi burada yapılıyor.*/
                if (i == 0 || i == 1)
                {
        ...
        public string metin(string textBoxMetin)    //spn sifreleme şlemlerinin başladığı method
        {
